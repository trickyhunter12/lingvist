...
Mamaev -> Word<wff="[Мм]амаев[а-я]*"> Word<wff="[Кк]урган">;
...
Places -> Mamaev | Avangard | Square | Phihlip| Dzerzhinsky | Chekisty | Church | Echelon | Mill | FireMan | Pavlov | Chelyb | Gogol | BK| Synagogue | BarmFount | LoversFount | Mount | Panikaha  | Cathedral | Port | Opera | WinPark | Arena |Filarm |Planet|CentPark|Botan|FriendshipPark|ChildPark|Comsomol|WinPark;

S -> Places interp (Data.Object_output);